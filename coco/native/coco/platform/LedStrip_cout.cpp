...
Awaitable<> LedStrip_cout::stateChange(int waitFlags) {
...
LedStrip_cout::Buffer::Buffer(LedStrip_cout &device, int length)
	: BufferImpl(0, new uint8_t[length * 3], length * 3, device.stat)
	, device(device)
{
